...
ANIME_LUGAT = {
    ...
    "komediya": {
        "nom": "😂 Komediya anime so'zlari",
        "sozlar": [
            ("Шутка / Я пошутил", "Hazil / hazillashdim"),
            ("Смешно!", "Kulgili!"),
            ("Не смешно", "Kulgili emas"),
            ("Прикол", "Qiziq hazil (yoshlar tili)"),
            ("Ты что, дурак?", "Nima, ahmoqmisan?"),
            ("С ума сошёл?", "Aqldan ozdingmi?"),
            ("Позор", "Sharmandalik"),
            ("Неловко", "Noqulay"),
            ("Стыдно", "Uyat"),
            ("Как глупо", "Qanday ahmoqona"),
            ("Перестань!", "Bas qil!"),
            ("Да ладно тебе", "Qo'ysang-chi"),
            ("Ты серьёзно?", "Jiddiy aytyapsanmi?"),
            ("Умора!", "Kulgidan o'laman!"),
            ("Чепуха / Ерунда", "Bema'nilik / safsata"),
            ("Балбес", "Landavur (hazil ohangida)"),
            ("Придурок", "Ovsar (qo'pol hazil)"),
            ("Что за бред?", "Bu qanaqa safsata?"),
            ("Обалдеть!", "Esim ketdi! / Qoyil!"),
            ("Ну ты даёшь!", "Sen ham oshirvording!"),
        ],
    },
    "romantika": {
        "nom": "💘 Romantik anime so'zlari",
        "sozlar": [
            ("Я тебя люблю", "Seni sevaman"),
            ("Ты мне нравишься", "Sen menga yoqasan"),
            ("Признание", "Sevgi izhori (kokuhaku)"),
            ("Свидание", "Uchrashuv (romantik)"),
            ("Первая любовь", "Birinchi muhabbat"),
            ("Влюбиться", "Sevib qolmoq"),
            ("Поцелуй", "Bo'sa"),
            ("Обнять", "Quchoqlamoq"),
            ("Скучаю по тебе", "Seni sog'indim"),
            ("Ты такая красивая", "Sen juda go'zalsan"),
            ("Милый / Милая", "Yoqimtoy / shirinim"),
            ("Сердце бьётся", "Yurak (tez) urmoqda"),
            ("Краснеть", "Qizarib ketmoq"),
            ("Ревновать", "Rashk qilmoq"),
            ("Расставание", "Ajralish"),
            ("Разбитое сердце", "Singan yurak"),
            ("Будь моей девушкой", "Mening qiz do'stim bo'l"),
            ("Мы просто друзья", "Biz shunchaki do'stmiz"),
            ("Навсегда вместе", "Abadiy birga"),
            ("Судьбоносная встреча", "Taqdiriy uchrashuv"),
        ],
    },
    "drama": {
        "nom": "🎭 Drama anime so'zlari",
        "sozlar": [
            ("Почему ты ушёл?", "Nega ketding?"),
            ("Не бросай меня", "Meni tashlab ketma"),
            ("Мне больно", "Menga alam qilyapti"),
            ("Я виноват", "Men aybdorman"),
            ("Это моя вина", "Bu mening aybim"),
            ("Прости, если сможешь", "Kechir, qo'lingdan kelsa"),
            ("Одинокий", "Yolg'iz"),
            ("Страдание", "Azob / iztirob"),
            ("Горе", "Qayg'u"),
            ("Потеря", "Yo'qotish"),
            ("Похороны", "Dafn marosimi"),
            ("Болезнь", "Kasallik"),
            ("Больница", "Kasalxona"),
            ("Воспоминание о прошлом", "O'tmish xotirasi"),
            ("Я больше не могу", "Boshqa chiday olmayman"),
            ("Всё изменилось", "Hammasi o'zgardi"),
            ("Ты изменился", "Sen o'zgarding"),
            ("Начать всё сначала", "Hammasini boshidan boshlash"),
            ("Жизнь продолжается", "Hayot davom etadi"),
            ("Я никогда тебя не забуду", "Seni hech qachon unutmayman"),
        ],
    },
}
